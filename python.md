1. [MongoDB data stream pipeline tools by YouGov (adopted from MongoDB) syncronize data between Mongo vs Elastic search](https://github.com/yougov/mongo-connector)
